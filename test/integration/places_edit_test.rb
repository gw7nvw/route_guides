...
class PlacesEditTest < ActionDispatch::IntegrationTest

  def setup
    init()
  end

test "view new single place as user" do
...
test "view edit single place as user" do
    #navigate to my route
    login_as(@testuser.name,"password")
    assert is_logged_in?

    get '/places/'+@testplace.id.to_s+'/edit'
    assert :success
...
test "edit single place as user" do
    #navigate to my route
    login_as(@testuser.name,"password")
    assert is_logged_in?

    patch '/places/'+@testplace.id.to_s, place: { name: "A"*255, experienced_at: "2015-01-01", place_type: "Roadend", place_owner: "Private", description: "B"*3000, location: "169.06157452349277 -44.20474889903012", projection_id: "27200", x: "2195332.0", y: "5659513.3", altitude: "4444"}, save: "Save"

    assert :success
    assert_template 'places/show'

    assert_select "div#place_title1", "A"*255+" (Private Roadend)"
    assert_select "div#place_locn1", "NZTM2000: 1285319, 5097838 (alt: 4444m)"
    assert_select "div#fw_p1", "B"*3000
...
test "view edit single place as not-creating-user" do
    ...
    patch '/places/'+@testplace.id.to_s, place: { name: "B"*255, experienced_at: "2015-01-01", place_type: "Roadend", place_owner: "Private", description: "M"*3000, location: "169.06157452349277 -44.20474889903012", projection_id: "27200", x: "2195332.0", y: "5659513.3", altitude: "4444"}, save: "Save"
...
test "create single place as user" do
    ...
    post '/places/', place: { name: "C"*255, experienced_at: "2015-01-01", place_type: "Roadend", place_owner: "Private", description: "M"*3000, location: "169.06157452349277 -44.20474889903012", projection_id: "27200", x: "2195332.0", y: "5659513.3", altitude: "4444"}, save: "Save"

    assert :success
    assert_template 'places/show'

    assert_select "div#place_title1", "C"*255+" (Private Roadend)"
    assert_select "div#place_locn1", "NZTM2000: 1285319, 5097838 (alt: 4444m)"
    assert_select "div#fw_p1", "M"*3000
...
test "handle mandatory parameter errors in edit place" do
    ...
    #name
    patch '/places/'+@testplace.id.to_s, place: { name: "", experienced_at: "2015-01-01", place_type: "Roadend", place_owner: "Private", description: "B"*3000, location: "169.06157452349277 -44.20474889903012", projection_id: "27200", x: "2195332.0", y: "5659513.3", altitude: "4444"}, save: "Save"
    ...
    #experienced_at
    #name
    patch '/places/'+@testplace.id.to_s, place: { name: "BBB", experienced_at: "", place_type: "Roadend", place_owner: "Private", description: "B"*3000, location: "169.06157452349277 -44.20474889903012", projection_id: "27200", x: "2195332.0", y: "5659513.3", altitude: "4444"}, save: "Save"
    ...
    #projection
    patch '/places/'+@testplace.id.to_s, place: { name: "BBB", experienced_at: "2015-01-01", place_type: "Roadend", place_owner: "Private", description: "B"*3000, location: "169.06157452349277 -44.20474889903012", projection_id: "", x: "2195332.0", y: "5659513.3", altitude: "4444"}, save: "Save"
    ...
    #x
    patch '/places/'+@testplace.id.to_s, place: { name: "BBB", experienced_at: "2015-01-01", place_type: "Roadend", place_owner: "Private", description: "B"*3000, location: "169.06157452349277 -44.20474889903012", projection_id: "27200", x: "", y: "5659513.3", altitude: "4444"}, save: "Save"
    ...
    #y
    patch '/places/'+@testplace.id.to_s, place: { name: "BBB", experienced_at: "2015-01-01", place_type: "Roadend", place_owner: "Private", description: "B"*3000, location: "169.06157452349277 -44.20474889903012", projection_id: "27200", x: "2722222", y: "", altitude: "4444"}, save: "Save"
    ...
    #min fields allowed
    patch '/places/'+@testplace.id.to_s, place: { name: "BBB", experienced_at: "2015-01-01", place_type: "Roadend", place_owner: "", description: "", location: "", projection_id: "27200", x: "2195332.0", y: "5659513.3", altitude: ""}, save: "Save"
...
test "handle mandatory parameter errors in new place" do
    ...
    pl=Place.count
    #name
    post '/places/', place: { name: "", experienced_at: "2015-01-01", place_type: "Roadend", place_owner: "Private", description: "B"*3000, location: "169.06157452349277 -44.20474889903012", projection_id: "27200", x: "2195332.0", y: "5659513.3", altitude: "4444"}, save: "Save"
    ...
    #experienced_at
    post '/places/', place: { name: "BBB", experienced_at: "", place_type: "Roadend", place_owner: "Private", description: "B"*3000, location: "169.06157452349277 -44.20474889903012", projection_id: "27200", x: "2195332.0", y: "5659513.3", altitude: "4444"}, save: "Save"
    ...
    #type
    post '/places/', place: { name: "BBB", experienced_at: "2015-01-01", place_type: "", place_owner: "Private", description: "B"*3000, location: "169.06157452349277 -44.20474889903012", projection_id: "27200", x: "2195332.0", y: "5659513.3", altitude: "4444"}, save: "Save"
    ...
    #projection
    post '/places/', place: { name: "BBB", experienced_at: "2015-01-01", place_type: "Roadend", place_owner: "Private", description: "B"*3000, location: "169.06157452349277 -44.20474889903012", projection_id: "", x: "2195332.0", y: "5659513.3", altitude: "4444"}, save: "Save"
    ...
    #x
    post '/places/', place: { name: "BBB", experienced_at: "2015-01-01", place_type: "Roadend", place_owner: "Private", description: "B"*3000, location: "169.06157452349277 -44.20474889903012", projection_id: "27200", x: "", y: "5659513.3", altitude: "4444"}, save: "Save"
    ...
    #y
    post '/places/', place: { name: "BBB", experienced_at: "2015-01-01", place_type: "Roadend", place_owner: "Private", description: "B"*3000, location: "169.06157452349277 -44.20474889903012", projection_id: "27200", x: "2722222", y: "", altitude: "4444"}, save: "Save"
    ...
    #min fields allowed
    post '/places/', place: { name: "BBB", experienced_at: "2015-01-01", place_type: "Roadend", place_owner: "", description: "", location: "", projection_id: "27200", x: "2195332.0", y: "5659513.3", altitude: ""}, save: "Save"
