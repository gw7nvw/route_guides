...
function print_init(user_id) {
  ...
  map_map.once('postrender', function(event) {
    ...
    rasterListenerKey = print_source.getSource().on('tileloadend', function() {
      raster_loaded_count++;
      if(raster_load_count==raster_loaded_count)  {
        var last_raster_load_count=raster_load_count;
        setTimeout( function() {
          if(raster_load_count==last_raster_load_count) print_raster_ready=true;
...
function site_add_my_layers(user_id) {
  ...
  myplaces_layer=map_add_vector_layer("My Places", "http://routeguides.co.nz/cgi-bin/mapserv?map=/var/www/html/rg_maps/rg_map.map", "myplaces",site_pink_dot,false,1,32,'user_id='+user_id);
  myroutes_layer=map_add_vector_layer("My Routes", "http://routeguides.co.nz/cgi-bin/mapserv?map=/var/www/html/rg_maps/rg_map.map", "myroutes",site_red_line,false,8,32,'user_id='+user_id);
  myroutes_simple_layer=map_add_vector_layer("My Routes Simple", "http://routeguides.co.nz/cgi-bin/mapserv?map=/var/www/html/rg_maps/rg_map.map", "myroutes-simple",site_red_line,false,1,8,'user_id='+user_id);
...
function site_add_vector_layers() {
  ...
  parks_layer=map_add_vector_layer("Parks", "http://routeguides.co.nz/cgi-bin/mapserv?map=/var/www/html/rg_maps/rg_map.map", "parks",site_docland_style,false,11,32);
  parks_simple_layer=map_add_vector_layer("Parks Simple", "http://routeguides.co.nz/cgi-bin/mapserv?map=/var/www/html/rg_maps/rg_map.map", "parks_simple",site_docland_style,false,8,11);
  parks_very_simple_layer=map_add_vector_layer("Parks Very Simple", "http://routeguides.co.nz/cgi-bin/mapserv?map=/var/www/html/rg_maps/rg_map.map", "parks_very_simple",site_docland_style,false,1,8);
