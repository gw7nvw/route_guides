...
Routeclass.create(name: "routetype", description: "Route type")
Routeclass.create(name: "importance", description: "Importance")
Routeclass.create(name: "gradient", description: "Gradient")
Routeclass.create(name: "terrain", description: "Terrain / vegetation")
Routeclass.create(name: "alpinesummer", description: "Alpine: Summer skills")
Routeclass.create(name: "alpinewinter", description: "Alpine: Winter skills")
Routeclass.create(name: "river", description: "Rivers")
